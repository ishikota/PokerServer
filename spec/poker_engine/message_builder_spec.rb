...
RSpec.describe MessageBuilder do
  ...
  let(:message_builder) { MessageBuilder.new(formatter) }
  ...
  describe "game_start_message" do
    ...
    it "should create correct message" do
      ...
      msg = message_builder.game_start_message(config, seats)
      expect(msg["message_type"]).to eq MessageBuilder::Type::GAME_START_MESSAGE
  ...
  describe "street_start_message" do
    ...
    it "should create correct message" do
      msg = message_builder.street_start_message(round_manager, table)
      expect(msg["message_type"]).to eq MessageBuilder::Type::STREET_START_MESSAGE
  ...
  describe "game_update_message" do
    ...
    it "should create correct message" do
      ...
      msg = message_builder.game_update_message(player_pos, action, amount, round_manager, table)
      expect(msg["message_type"]).to eq MessageBuilder::Type::GAME_UPDATE_MESSAGE
  ...
  describe "game_result_message" do
    ...
    it "should create correcgt message" do
      msg = message_builder.game_result_message(seats)
      expect(msg["message_type"]).to eq MessageBuilder::Type::GAME_RESULT_MESSAGE
